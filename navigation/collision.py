...
def line_intersection2(line1, line2):
    ...
    x = det(d, xdiff) / div
    y = det(d, ydiff) / div
    cond = min([line1[0][0], line1[1][0]]) < x < max([line1[0][0], line1[1][0]]) and \
...
def line_intersection(line1, line2):
    ...
    return intersection(L1, L2, line1, line2)


def intersection(L1, L2, line1, line2):
...
def ray_projection(ray, walls):
    ...
    for wall in walls:
        ...
        inter = line_intersection2(ray, wall)
        # if inter is not None:
        #    intersections.append(inter)
